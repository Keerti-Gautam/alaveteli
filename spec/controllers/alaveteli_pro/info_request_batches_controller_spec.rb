...
shared_examples_for "an info_request_batch action" do
  ...
  it "sets @info_request_batch" do
    with_feature_enabled(:alaveteli_pro) do
      ...
      expect(assigns[:info_request_batch].public_bodies).to eq bodies
  ...
  it "sets @example_info_request" do
    with_feature_enabled(:alaveteli_pro) do
      ...
      expect(assigns[:example_info_request].public_body).to eq draft.public_bodies.first
    ...
    context "when everything is valid" do
      it "creates an info_request_batch" do
        with_feature_enabled(:alaveteli_pro) do
          ...
          expect(new_batch.public_bodies).to eq draft.public_bodies
